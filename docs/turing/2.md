...
To change and customize the name of your program, enter your title in the first line of the **{{ config_file }}** file.
...
To change what will get executed in CAIP just enter the file name/URI in the **fourth** line of the **{{ config_file }}**.
